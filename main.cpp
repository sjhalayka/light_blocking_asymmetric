...
int main(int argc, char** argv)
{
	...
	for (size_t i = 0; i < centres.size(); i++)
		input_light_mat.at<Vec4b>(centres[i].y / tile_size, centres[i].x / tile_size) = Vec4b(distinct_colours[i].r * 255.0f, distinct_colours[i].g * 255.0f, distinct_colours[i].b * 255.0f, 255.0f);
